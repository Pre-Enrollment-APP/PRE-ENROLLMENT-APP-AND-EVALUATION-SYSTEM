...
public class contact_us extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (uri != null) {
                    Picasso.with(contact_us.this).load(uri).into(profilepic);
                } else {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) { switch (item.getItemId()){
        case R.id.nav_home:
            Intent intent2=new Intent(contact_us.this,Home_Page.class);
        ...
        case R.id.nav_profile:
            ...
            break;
        case R.id.nav_about:
            Intent intent1=new Intent(contact_us.this,About.class);
        ...
        case R.id.nav_logout:
            ...
            Intent intent4=new Intent(contact_us.this, login.class);
